...
<html>
  ...
  <body>
    ...
    <aside id="left">
      <h4>카테고리</h4>
      <ul>
        <li><a target="iframe1" href="board.php?board_id=notice">Q&A게시판</a></li>
        <li><a target="iframe1" href="board.php?board_id=board">리뷰게시판</a></li>
      </ul>
    </aside>
    <section id="main">
      <article id="article1">
